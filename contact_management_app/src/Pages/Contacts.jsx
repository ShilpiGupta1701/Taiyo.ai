...
const Contacts = () => {
    ...
    return (
        <div className="justify-center pt-16 text-gray-50  p-4  w-full ">
            <div className="m-4">
                <button className="rounded bg-red-600 hover:bg-pink-600 p-2 text-3xl text-white">
            ...
            <div id="contact_list" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                {
                    AllContacts.map((el) => {
                        return <div key={el.id} className="bg-blue-300 rounded-lg shadow-md m-4 p-4 text-black">
                            ...
                            <div className="flex justify-between my-2">
                                <Link to={`edit/${el.id}`}>
                                    <button className="rounded p-2 bg-green-700 text-white">

                                        Edit
                                    </button>
                                </Link>

                                <button onClick={() => dispatch(removeContact(el.id))} className="rounded p-2 bg-red-700 text-white">Delete</button>
                            </div>
                        </div>
                    })
                }
